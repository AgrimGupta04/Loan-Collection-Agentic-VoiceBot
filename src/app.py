...
# Initialize DB, Caller, Outcome agent
db = Database()
...
# Section 2: Local Test with Audio File
st.header("🎙️ Local Pipeline Test (Voice Note → STT → DB Update → TTS)")
...
if uploaded_file is not None:
    ...
    if customers:
        customer_id = customers[0][0]  # Take first pending customer
